...
<body>
    ...
    <section id="home" class="home">
        <h1>Welcome to Football Academy</h1>
...
.home {
    background: linear-gradient(rgba(76, 175, 80, 0.8), rgba(69, 160, 73, 0.8)), url('https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?w=1200&h=600&fit=crop') center/cover;
    color: white;
    text-align: center;
    min-height: 500px;
    display: flex;
...
.service-box:nth-child(1) .service-icon {
    background-image: url('https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=300&h=150&fit=crop');
}
...
.about {
    background: linear-gradient(rgba(245, 245, 245, 0.95), rgba(245, 245, 245, 0.95)), url('https://images.unsplash.com/photo-1577223625816-7546f13df25d?w=1200&h=400&fit=crop') center/cover;
}
...
.stadium-image {
    width: 400px;
    height: 250px;
    background-image: url('https://images.unsplash.com/photo-1459865264687-595d652de67e?w=400&h=250&fit=crop');
    background-size: cover;
    background-position: center;
    border-radius: 15px;
...
## OUTPUT
<img width="1568" height="938" alt="Screenshot 2026-02-24 152823" src="https://github.com/user-attachments/assets/17ec0b27-0e89-4769-a1fd-320e81e19639" />
<img width="1568" height="932" alt="Screenshot 2026-02-24 152843" src="https://github.com/user-attachments/assets/709346b1-d412-4aaf-85b4-59a7804e5f0b" />
<img width="1570" height="942" alt="Screenshot 2026-02-24 152903" src="https://github.com/user-attachments/assets/c2a55c37-7d65-4330-9d9f-369edcf851f1" />
